...
public class QuieterLightningBoltEntityRendererNeoForge extends EntityRenderer<QuieterLightningBoltEntityNeoForge> {

    public QuieterLightningBoltEntityRendererNeoForge(EntityRendererProvider.Context p_174286_) {
        super(p_174286_);
    }

    public void render(QuieterLightningBoltEntityNeoForge p_115266_, float p_115267_, float p_115268_, PoseStack p_115269_, MultiBufferSource p_115270_, int p_115271_) {
    ...
    public ResourceLocation getTextureLocation(QuieterLightningBoltEntityNeoForge p_115264_) {
