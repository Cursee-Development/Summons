...
import com.cursee.summons.core.client.entity.animations.BattleSummonAnimations;
...
public class BattleSummonModel<T extends BattleSummonEntity> extends HierarchicalModel<T> {
    ...
    @Override
    public void setupAnim(BattleSummonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.root().getAllParts().forEach(ModelPart::resetPose);
        this.applyHeadRotation(netHeadYaw, headPitch);
        this.animateWalk(BattleSummonAnimations.WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
        this.animate(entity.idleAnimationState, BattleSummonAnimations.IDLE, ageInTicks, 1f);
        this.animate(entity.attackAnimationState, BattleSummonAnimations.ATTACK, ageInTicks, 1f);
    }
